...
Sejam muito bem-vindos ao Simulator - Nível #1! Neste nível você teve a oportunidade de aprender sobre Versionamento Semântico, GitHub, GIT, Configuração de Ambiente Dev, Introdução ao JavaScript, Funções, Manipulação de Arrays e Objetos,JSON e
Promises.
...
Descrição: Como membro da equipe financeira, desejo receber e exibir os dados dos repasses do governo, 
para acompanhar as transações efetuadas.
...
O sistema deverá exibir um resumo dos repasses bem sucedidos. Esse resumo
